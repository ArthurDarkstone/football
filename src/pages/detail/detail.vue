        ...
        class="race-content">
  	     <div>
  		    <div class="time-panel">
  		    	<div class="row">
  		    		<div class="team">
  		    			<div><img v-lazy="race.teama_logo" alt="球队logo"></div>
  		    			<p v-text="race.teama_name"></p>
  		    		</div>
  		    		<div class="content">
  		    			<p>
                  <span v-text="race.schedule_location"></span>
                  <span v-text="new Date(race.schedule_time).toLocaleTimeString()"></span>
                  <span v-if="race.schedule_turn_name" v-text="race.schedule_turn_name"></span>
  		    		...
  		    		<div class="team">
  		    			<div><img v-lazy="race.teamb_logo" alt=""></div>
  		    			<p v-text="race.teama_name"></p>
  		    		</div>
  		    	</div>
            <div class="">
